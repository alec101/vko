...
struct VkoExtensions {
  ...
  // from all the manually enabled instance extensions, creates the array of null-terminated strins to pass to vulkan; <out_nrExtensions> will return number of extensions written; dealloc with delete[]
  ...
  // from all the manually enabled device extensions, creates the array of null-terminated strins to pass to vulkan; <out_nrExtensions> will return number of extensions written; dealloc with delete[]
  ...
  union {
    struct {
      ...
      VkoExt vk_EXT_validation_flags;               // #062 [instance] [instance creation: pNext extra struct] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_validation_flags
  ...
  union {
    struct {
    VkoExt vk_KHR_8bit_storage;                   // #178 [device] [allows use of 8-bit types in uniform and storage buffers] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_8bit_storage
    VkoExt vk_KHR_create_renderpass2;             // #110 [device] [extended render passes] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_create_renderpass2
    ...
    VkoExt vk_KHR_draw_indirect_count;            // #170 [device] [generate arbitrary amounts of draw commands and execute them without host intervention] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_draw_indirect_count
    VkoExt vk_KHR_driver_properties;              // #197 [device] [what driver coresponds to what GPU] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_driver_properties
    ...
    VkoExt vk_KHR_image_format_list;              // #148 [device] [provide the list of all formats that can be used with an image when it is created] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_image_format_list
    ...
    VkoExt k_KHR_sampler_mirror_clamp_to_edge;   // #015 [device] [mirror_clamp_to_edge<- textures] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_sampler_mirror_clamp_to_edge
    VkoExt vk_KHR_shader_atomic_int64;            // #181 [device] [int64] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_shader_atomic_int64
    ...
    VkoExt vk_EXT_descriptor_indexing;            // #162 [device] [descriptor sets containing substantially all of app resources] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_descriptor_indexing
    ...
    VkoExt vk_EXT_sampler_filter_minmax;          // #131 [device] [new sampler parameter] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_sampler_filter_minmax
    VkoExt vk_EXT_scalar_block_layout;            // #222 [device] [modifies the alignment rules for uniforms/etc buffers] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_scalar_block_layout
    VkoExt vk_EXT_separate_stencil_usage;         // #247 [device] [image creation flags for stencil/depth stencil] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_separate_stencil_usage
    ...
    VkoExt vk_EXT_shader_viewport_index_layer;    // #163 [device] [vars with Layer and ViewportIndex built-ins can be exported] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_shader_viewport_index_layer
    ...
    VkoExt vk_AMD_gpu_shader_half_float;          // #037 [device] [support for SPV_AMD_gpu_shader_half_float] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_AMD_gpu_shader_half_float
    VkoExt vk_AMD_gpu_shader_int16;               // #133 [device] [support for SPV_AMD_gpu_shader_int16] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_AMD_gpu_shader_int16
    ...
    // PROVISIONAL
    VkoExt vk_KHR_vulkan_memory_model;            // #212 [device] PROVISIONAL  [sync memory accessed by multiple shaders] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_vulkan_memory_model
    };
    VkoExt raw[92];
  } device;
  ...
  union {
    struct {
      ...
      VkoExt vk_AMD_negative_viewport_height;       // #036 [device] [DEPRECATED by VK_KHR_maintenance1 that is promoted to Vulkan 1.1] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_AMD_negative_viewport_height
      VkoExt vk_NV_dedicated_allocation;            // #027 [device] [DEPRECATED by VK_KHR_dedicated_allocation that was promoted to Vulkan 1.1] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_NV_dedicated_allocation
      VkoExt vk_NV_external_memory;                 // #057 [device] [DEPRECATED by VK_KHR_external_memory that was promoted to Vulkan 1.1] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_NV_external_memory
