...
VkoExtensions::VkoExtensions() {
  ...
  instance.raw[a++]= {"VK_EXT_validation_flags",               62, 0, 0, 0}; // [instance creation: pNext extra struct] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_validation_flags
  ...
  // device extensions
  a= 0;
  device.raw[a++]= {"VK_KHR_8bit_storage",                     178, 1, 0, 0}; // [allows use of 8-bit types in uniform and storage buffers] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_8bit_storage
  device.raw[a++]= {"VK_KHR_create_renderpass2",               110, 1, 0, 0}; // [extended render passes] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_create_renderpass2
  ...
  device.raw[a++]= {"VK_KHR_draw_indirect_count",              170, 1, 0, 0}; // [generate arbitrary amounts of draw commands and execute them without host intervention] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_draw_indirect_count
  device.raw[a++]= {"VK_KHR_driver_properties",                197, 1, 0, 0}; // [what driver coresponds to what GPU] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_driver_properties
  ...
  device.raw[a++]= {"VK_KHR_image_format_list",                148, 1, 0, 0}; // [provide the list of all formats that can be used with an image when it is created] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_image_format_list
  ...
  device.raw[a++]= {"VK_KHR_sampler_mirror_clamp_to_edge",      15, 1, 0, 0}; // [mirror_clamp_to_edge<- textures] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_sampler_mirror_clamp_to_edge
  device.raw[a++]= {"VK_KHR_shader_atomic_int64",              181, 1, 0, 0}; // [int64] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_KHR_shader_atomic_int64
  ...
  device.raw[a++]= {"VK_EXT_descriptor_indexing",              162, 1, 0, 0}; // [descriptor sets containing substantially all of app resources] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_descriptor_indexing
  ...
  device.raw[a++]= {"VK_EXT_sampler_filter_minmax",            131, 1, 0, 0}; // [new sampler parameter] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_sampler_filter_minmax
  device.raw[a++]= {"VK_EXT_scalar_block_layout",              222, 1, 0, 0}; // [modifies the alignment rules for uniforms/etc buffers] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_scalar_block_layout
  device.raw[a++]= {"VK_EXT_separate_stencil_usage",           247, 1, 0, 0}; // [image creation flags for stencil/depth stencil] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_separate_stencil_usage
  ...
  device.raw[a++]= {"VK_EXT_shader_viewport_index_layer",      163, 1, 0, 0}; // [vars with Layer and ViewportIndex built-ins can be exported] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_EXT_shader_viewport_index_layer
  ...
  device.raw[a++]= {"VK_AMD_gpu_shader_half_float",             37, 1, 0, 0}; // [support for SPV_AMD_gpu_shader_half_float] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_AMD_gpu_shader_half_float
  device.raw[a++]= {"VK_AMD_gpu_shader_int16",                 133, 1, 0, 0}; // [support for SPV_AMD_gpu_shader_int16] https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VK_AMD_gpu_shader_int16
